...
## Environments
- Preview: https://main--wesecure--wkndforms.hlx.page/
- Live: https://main--wesecure--wkndforms.hlx.live/
...
1. Open the `wesecure` directory in your favorite IDE and start coding :)
